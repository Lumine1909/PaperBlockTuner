...
public enum Instrument {
    ...
    TRUMPET("trumpet", org.bukkit.Instrument.TRUMPET, Material.COPPER_BLOCK),
    TRUMPET_EXPOSED("trumpet_exposed", org.bukkit.Instrument.TRUMPET_EXPOSED, Material.EXPOSED_COPPER),
    TRUMPET_WEATHERED("trumpet_weathered", org.bukkit.Instrument.TRUMPET_WEATHERED, Material.WEATHERED_COPPER),
    TRUMPET_OXIDIZED("trumpet_oxidized", org.bukkit.Instrument.TRUMPET_OXIDIZED, Material.OXIDIZED_COPPER),
